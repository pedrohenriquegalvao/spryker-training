...
class AuthorizePaymentCommand extends AbstractCommand implements CommandByOrderInterface
{
    ...
    public function run(
        ...
        return $this->handlePaymentAuthorization($orderItems, $orderEntity);
    }

    private function handlePaymentAuthorization(array $orderItems, SpySalesOrder $orderEntity): array
    {
        // Logic to handle payment authorization
        return [];
    }
}
