...
class ShipOrderCommand extends AbstractCommand implements CommandByOrderInterface
{
    ...
    public function run(
     ...
     return $this->handleShipping($orderItems, $orderEntity);
    }

    private function handleShipping(array $orderItems, SpySalesOrder $orderEntity): array
    {
        // Logic to handle shipping the order
        return [];
    }
}
